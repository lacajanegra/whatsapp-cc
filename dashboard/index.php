...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    //set user online]
    <? 
    if ($_SESSION["check-status"]=="no") {
?>
      var uOnLine = new Firebase('https://flickering-inferno-8829.firebaseio.com/online');
      uOnLine.push({id : '<?echo ($_SESSION["userId"]);?>', name: "<?echo ($_SESSION['userId']);?>", op:"online"});
<?
$_SESSION["check-status"]="yes";
echo $_SESSION["check-status"];
   ...
   <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?echo ($_SESSION['userId']);?></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <?echo ($_SESSION['userId']);?> - Agente WhatsappCC
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="build/includes/close-session.php" class="btn btn-default btn-flat" id="end-session">Cerrar Sesión</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <!-- Direct Chat -->
          <div id='messagesDiv' number="-1"></div>
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="box box-primary direct-chat direct-chat-primary">
                ...
                <div class="box-footer">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                        <button type="button" id="send-message" class="btn btn-primary btn-flat">Enviar</button>
                         <button type="button" id="end-chat" class="btn btn-primary btn-danger" style="margin-left:0.2em;">Fin</button>
                      </span>
                    </div>
    ...
    FSnWaitingStack.on('child_added', function(snapshot) { //Recibe mensaje
      var message = snapshot.val();
      console.log(message);
      displayStackWaiting(message.num);
      });
  FSnWaitingStack.on('child_removed', function(oldChildSnapshot) {
        message = oldChildSnapshot.val()
    ...
    FSmDirect.on('child_added', function(snapshot) { //Recibe mensaje
      var message = snapshot.val();
      if (message.to == "agent" && message.id=='<?echo ($_SESSION["userId"]);?>') {
          $('#messagesDiv').attr('number',message.num);
          displayChatMessageW(message.num, message.text);
      }else if(message.from=='<?echo ($_SESSION["userId"]);?>'){
     ...
     function displayChatMessageW(name, text) {
      ...
      var compose = '<li id="'+ num +'"><a href="#">'+ num +' <span class="pull-right badge bg-blue">Ir</span></a></li>';
...
$('#messageInput').keypress(function (e) {
            if (e.keyCode == 13) {
                ...
                if(number!=-1){
                  FSmDirect.push({text: text, to: "whatsapp", num: number, from:"<?echo ($_SESSION['userId']);?>"});
                }
...
$('#end-chat').on("click",function(){
      ...
      var number = $('#messagesDiv').attr('number');
      uOnLine.push({id : '<?echo ($_SESSION["userId"]);?>', name: "<?echo ($_SESSION['userId']);?>", op:"available", num: number});
      $('#messagesDiv').attr('number','-1');
      //clear chat
...
$('#end-session').on("click",function(){
      ...
      uOnLine.push({id : '<?echo ($_SESSION["userId"]);?>', name: "<?echo ($_SESSION['userId']);?>", op:"offline"});
